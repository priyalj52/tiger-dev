    ...
    return (
        ...
        border: "1px solid rgba( 255, 255, 255, 0.18 )"
            ...
            <div className="card-body" style={{
                ...
                <div className="card-text">
                   <a href = "/CollectionDescription" onClick={()=>{toComponentDesc()}}><button type="button"  style = {{borderRadius:"25%", background:"lightgreen",border:"none",color:"white"}}>BUY </button></a>
                </div>
